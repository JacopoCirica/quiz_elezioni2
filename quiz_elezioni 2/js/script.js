...
function showQuetion(index){
  if (continua_a_leggere.classList.contains('show')) {
    ...
    let option_tag = '<div class="domanda"><p>Chi lo dice?</p></div><div class="prova2"><img class= "dot" id= "' + obj[index].partiti[0].partito + '" src="/img/' + obj[index].partiti[0].simbolo + '"></span> <p class=didascalia>'+ obj[index].partiti[0].descr_lista + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + obj[index].partiti[1].partito + '" src="/img/' + obj[index].partiti[1].simbolo + '"></img></span> <p class=didascalia>'+ obj[index].partiti[1].descr_lista + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + obj[index].partiti[2].partito + '" src="/img/' + obj[index].partiti[2].simbolo + '"></span> <p class=didascalia>'+ obj[index].partiti[2].descr_lista + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + obj[index].partiti[3].partito + '" src="/img/' + obj[index].partiti[3].simbolo + '"></span> <p class=didascalia>'+ obj[index].partiti[3].descr_lista + '</p></div>'
    +'<div class="prova2"><img class= "dot" id= "' + obj[index].partiti[4].partito + '" src="/img/' + obj[index].partiti[4].simbolo + '"></span> <p class=didascalia>'+ obj[index].partiti[4].descr_lista + '</p></div></div>';
...
function optionSelected(answer){
    ...
    let correcAns = obj[que_count].risposta_partito; //getting correct answer from array
    ...
    if(userAns == correcAns){ //if user selected option is equal to array's correct answer
        ...
        let crossIconTaggreen = '<img src="img/green_icon.svg.png" class="icon_incorrect1" alt="">';
        ...
        function setGlobal(){
          myStringArray.forEach(element => {
          if (element.partito===obj[que_count].risposta_partito) {
            nome_lista=element.descr_lista  
          } else if(element.partito===answer.id){
            nome_lista_sbagliata=element.descr_lista
            if (element.risposta_valore==="grey") {
...
function showResult(){
  ...
  for(i=0; i < numberall2; i++){
    ...
    if (userScore > 15){ // if user scored more than 3
        ...
        +'<p class="score_subtitle">Hai una ottima preparazione. Per migliorare vai su <a href="https://www.indecis.it">Indecis.it</a>. I programmi si trovano <a href="https://dait.interno.gov.it/elezioni/speciale-politiche">qui</a> </p>'
